- dashboard: sap_order_to_cash_02c_01_order_fulfillment_performance_tuning
  ...
  - name: Order Fulfillment
    ...
    width: 24
    height: 2
  - name: <a href="/dashboards/hp_cortex_sap_operational::sap_order_to_cash_o2c_01_a_delivery_performance_performance_tuning">Delivery
      Performance</a>
    type: text
    title_text: <a href="/dashboards/hp_cortex_sap_operational::sap_order_to_cash_o2c_01_a_delivery_performance_performance_tuning">Delivery
      Performance</a>
    subtitle_text: ''
    body_text: ''
    row: 8
  ...
  - title: In Full %
    name: In Full %
    model: hp_cortex_sap_operational
